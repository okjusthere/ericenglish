/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: a4e88288d5988e55100f04413eb31742)
...
interface __BaseEnv_Env {
	...
	DIRECT_LLM_API_BASE: "https://api.openai.com/v1";
	MONTHLY_AI_BUDGET_USD: "25";
	SPEECH_MODE: "azure_tts";
	REALTIME_SPEAK_ENABLED: "true";
	PRONUNCIATION_ASSESSMENT_ENABLED: "false";
	AZURE_OPENAI_ENDPOINT: "https://kevvrealtime-resource.cognitiveservices.azure.com";
	...
	AZURE_TEXT_DEPLOYMENT: "gpt-5.6-terra";
	...
	SESSION_ANALYSIS: Workflow<Parameters<import("./src/worker/index").SessionAnalysisWorkflow['run']>[0]['payload']>;
	WEEKLY_REPORT: Workflow<Parameters<import("./src/worker/index").WeeklyReportWorkflow['run']>[0]['payload']>;
	CURRICULUM_BOOTSTRAP: Workflow<Parameters<import("./src/worker/index").CurriculumBootstrapWorkflow['run']>[0]['payload']>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AUDIO_RETENTION_DAYS" | "DEFAULT_DAILY_MINUTES" | "AI_GATEWAY_BYOK_ALIAS" | "DIRECT_LLM_API_BASE" | "MONTHLY_AI_BUDGET_USD" | "SPEECH_MODE" | "REALTIME_SPEAK_ENABLED" | "PRONUNCIATION_ASSESSMENT_ENABLED" | "AZURE_OPENAI_ENDPOINT" | "AZURE_OPENAI_API_VERSION" | "AZURE_REALTIME_DEPLOYMENT" | "AZURE_TTS_DEPLOYMENT" | "AZURE_TRANSCRIBE_DEPLOYMENT" | "AZURE_TEXT_DEPLOYMENT" | "AZURE_TTS_VOICE" | "AZURE_SPEECH_ENDPOINT" | "AZURE_SPEECH_VOICE" | "APP_ENV" | "APP_TIMEZONE" | "SINGLE_USER_ID" | "OWNER_EMAIL" | "AI_PROVIDER_MODE" | "AI_GATEWAY_ACCOUNT_ID" | "AI_GATEWAY_ID" | "AI_GATEWAY_API_BASE" | "AI_MODEL_FAST" | "AI_MODEL_STRONG" | "AI_MODEL_CONTENT" | "AI_MODEL_STT" | "AI_MODEL_TTS" | "AI_GATEWAY_TOKEN" | "DIRECT_LLM_API_KEY" | "DIRECT_STT_API_KEY" | "DIRECT_TTS_API_KEY">> {}
}
