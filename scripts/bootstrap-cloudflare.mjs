...
config.vars={...config.vars,AI_PROVIDER_MODE:'workers_ai',AI_GATEWAY_ACCOUNT_ID:process.env.CLOUDFLARE_ACCOUNT_ID,AI_GATEWAY_ID:names.gateway,AI_GATEWAY_API_BASE:'',AI_GATEWAY_BYOK_ALIAS:'',AI_MODEL_FAST:process.env.AI_MODEL_FAST||'@cf/qwen/qwen3-30b-a3b-fp8',AI_MODEL_STRONG:process.env.AI_MODEL_STRONG||'@cf/meta/llama-3.3-70b-instruct-fp8-fast',AI_MODEL_CONTENT:process.env.AI_MODEL_CONTENT||'@cf/qwen/qwen3-30b-a3b-fp8',AI_MODEL_STT:process.env.AI_MODEL_STT||'@cf/openai/whisper-large-v3-turbo',AI_MODEL_TTS:''};
